            ...
            <div ref={ref} className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <div className="flex items-center justify-center gap-3 mb-4">
                        ...
                        <span className="font-rajdhani text-orange uppercase tracking-widest text-sm font-semibold">Client Stories</span>
                        <div className="h-px w-12 bg-orange" />
                    </div>
                ...
                >
                    ...
                    >
                        ...
                        <div
                            ...
                            style={{ color: 'rgba(255,107,43,0.1)' }}
                            aria-hidden="true"
                        >
                            "
                        </div>
                            ...
                            >
                                ...
                                <div className="flex gap-1 mb-4" aria-label={`Rating: ${TESTIMONIALS[current].rating} out of 5 stars`}>
                                    {[...Array(TESTIMONIALS[current].rating)].map((_, i) => (
                                        ...
                                        >
                                            <Star size={18} color="#ff6b2b" fill="#ff6b2b" />
                                        </motion.div>
                                    ))}
                                </div>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="font-source text-orange/80 text-sm">
                    ...
                    <div className="flex items-center justify-center gap-4 mt-8">
                        <button
                            ...
                            className="w-10 h-10 rounded-full flex items-center justify-center border border-silver/20 text-silver hover:border-orange hover:text-orange transition-all duration-200"
                        >
                            <ChevronLeft size={18} />
                        </button>
                        ...
                        <div className="flex gap-2" role="tablist" aria-label="Testimonial navigation">
                            {TESTIMONIALS.map((_, i) => (
                                <button
                                    ...
                                    style={{
                                        background: current === i ? '#ff6b2b' : 'rgba(192,200,216,0.3)',
