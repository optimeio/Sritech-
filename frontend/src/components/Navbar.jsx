        ...
        <>
            ...
            <motion.header
                ...
                style={{
                    ...
                    borderBottom: scrolled ? '1px solid rgba(30,58,95,0.4)' : 'none',
                ...
                >
                        ...
                        <motion.div whileHover={{ scale: 1.04 }} className="flex items-center gap-2 sm:gap-3">
                            <div className="relative flex-shrink-0">
                                ...
                                <img
                                    ...
                                    loading="eager"
                                    style={{ filter: 'brightness(0) invert(1) drop-shadow(0 0 8px rgba(255,107,43,0.9))' }}
                                />
                            </div>
                            {/* Full name on ≥sm */}
                            <div className="hidden sm:block">
                                <div className="font-rajdhani font-bold text-base text-offwhite leading-tight">Sri Tech Engineering</div>
                                <div className="text-orange text-xs font-source tracking-widest uppercase">Beyond Technology</div>
                            </div>
                            {/* Short name on xs */}
                            <div className="block sm:hidden">
                                <div className="font-rajdhani font-bold text-sm text-offwhite leading-tight">Sri Tech</div>
                                <div className="font-source uppercase" style={{ fontSize: 9, color: '#ff6b2b', letterSpacing: '0.1em' }}>Engineering</div>
                            </div>
                        </motion.div>
                    </a>
                        ...
                        {NAV_LINKS.map(link => (
                            <li key={link.href}>
                                <a
                                    ...
                                    style={{ color: activeSection === link.href.slice(1) ? '#ff6b2b' : '#c0c8d8' }}
                                >
                                    {link.label}
                                    <span
                                    ...
                                    />
                                    <span className="absolute bottom-0 left-0 h-0.5 bg-orange w-0 group-hover:w-full transition-all duration-300" />
                                </a>
                            </li>
                        ))}
                    </ul>
                    ...
                    <div className="flex items-center gap-2">
                        <motion.a
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="hidden md:inline-flex items-center gap-2 bg-orange text-white font-rajdhani font-bold px-4 py-2 rounded-lg text-sm uppercase tracking-wider hover:shadow-orange-glow transition-all duration-300"
                        >
                            Get a Quote
                        </motion.a>
                        ...
                        <button
                            ...
                            style={{
                                width: 44, height: 44,
                                background: mobileOpen ? 'rgba(255,107,43,0.12)' : 'transparent',
                                border: mobileOpen ? '1px solid rgba(255,107,43,0.35)' : '1px solid transparent',
                                color: mobileOpen ? '#ff6b2b' : '#c0c8d8',
                            }}
                ...
                {mobileOpen && (
                    <motion.div
                        ...
                        style={{
                            ...
                            zIndex: 49,
                            background: '#0a0c12',
                            borderBottom: '2px solid rgba(255,107,43,0.2)',
                    ...
                    >
                        <ul className="px-4 py-3 space-y-0.5" role="list">
                            {NAV_LINKS.map((link, i) => (
                                ...
                                >
                                    <a
                                        ...
                                        style={{
                                            height: 48,
                                            color: activeSection === link.href.slice(1) ? '#ff6b2b' : '#c0c8d8',
                                            background: activeSection === link.href.slice(1) ? 'rgba(255,107,43,0.08)' : 'transparent',
                                            borderLeft: activeSection === link.href.slice(1) ? '3px solid #ff6b2b' : '3px solid transparent',
                                        }}
                                    >
                                        {link.label}
                                    </a>
                            ...
                            >
                                <a
                                    ...
                                    onClick={(e) => scrollTo(e, '#contact')}
                                    aria-label="Get a Quote"
                                    className="flex items-center justify-center mt-2 bg-orange text-white font-rajdhani font-bold rounded-xl uppercase tracking-wider text-sm transition-all duration-200 active:scale-95"
                                    style={{ height: 48, boxShadow: '0 4px 20px rgba(255,107,43,0.35)' }}
                                >
                                    Get a Quote →
                                </a>
                            </motion.li>
                        ...
                        >
                            ...
                            <span className="font-source text-xs" style={{ color: 'rgba(255,107,43,0.5)' }}>sritechengineering8@gmail.com</span>
                        </div>
                    </motion.div>
                )}
            </AnimatePresence>
